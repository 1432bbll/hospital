...
map<int, advice> hospital::adviceList;
map<int, medicine> hospital::medicineList;
...
const int hospital::adviceLimit=10000;
const int hospital::medicineLimit=10000;
...
void hospital::printAdvice()
{
    for (auto i : adviceList)
        i.second.printDetails(), cout << "\n";
    return;
}
void hospital::printMedicine()
{
    for (auto i : medicineList)
        i.second.printDetails(), cout << "\n";
    return;
}